...
# UPDATED: Replaced gemini-2.5-flash with gemini-3.6-flash
    ...
    for current_model in models_to_try:
        for attempt in range(max_retries_per_model + 1):
            try:
                ...
                # OPTIMIZED: Proactive delay removed to speed up training loop inference
                # time.sleep(4)
                return response
            except Exception as e:
                last_exception = e
    ...
    try:
        ...
        response = generate_content_with_fallback(
            ...
            config=types.GenerateContentConfig(
                ...
                temperature=0.2,
                max_output_tokens=250, # Capped tokens
            ),
