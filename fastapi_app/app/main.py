...
app = FastAPI(
    title="AI Skin Intelligence - Skin Assessment Engine API",
    description="Module 3: Rule-Based Skin Health Assessment Engine, Score Generator (0-100), Concern Prioritization & Risk Factor Analysis.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
