...
const inMemoryStore = {
  ...
  consultations: [
    {
      ...
      priority: 'Standard',
      consultant: 'Ananya Iyer, LE',
      dermatologist: 'Dr. Rajni Verma, MD',
  ...
  chat_messages: [
    ...
    },
    {
      ...
      sender_avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150',
      recipient_id: '2',
      recipient_name: 'Ananya Iyer, LE',
      recipient_role: 'consultant',
      recipient_avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150',
      message: 'Thank you Ananya! The ceramide night barrier balm is working wonders. T-zone erythema is down noticeably.',
      message_type: 'text',
      read: true,
    ...
    },
    {
      ...
      message: 'Thank you Dr. Verma! I will continue the PM application schedule with SPF 50 every morning.',
      message_type: 'text',
      read: true,
    ...
    },
    {
      ...
      recipient_role: 'dermatologist',
      recipient_avatar: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=150',
      message: 'Dr. Verma, Sarah Jenkins (User 5) completed her barrier restoration cycle. Her erythema rating dropped from 60 to 32.',
      message_type: 'text',
      read: true,
    ...
    },
    {
      ...
      recipient_role: 'consultant',
      recipient_avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150',
      message: 'Hi Ananya, the soothing Centella serum is working wonders. No stinging or flaking after washing.',
      message_type: 'text',
      read: true,
    ...
    },
    {
      ...
      recipient_role: 'dermatologist',
      recipient_avatar: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=150',
      message: 'Dr. Verma, the clindamycin wash has eliminated the painful pustules along my jawline.',
      message_type: 'text',
      read: true,
