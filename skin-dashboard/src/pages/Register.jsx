...
import { UserPlus, Mail, Lock, UserCheck, ArrowRight } from "lucide-react";
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-slate-800/90 border border-slate-200/80 dark:border-slate-700/80 shadow-xl shadow-slate-200/50 dark:shadow-none">
            <div className="text-center mb-6">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 m-0">
                Join AI Skin Intelligence Platform
              </p>
            </div>
            ...
            <form onSubmit={handleRegister} className="space-y-3.5">
              <div>
                ...
                <div className="relative">
                  <UserCheck size={16} className="absolute left-3.5 top-3 text-slate-400" />
                  <input
                    type="text"
              ...
              <div>
                ...
                <select
                  className="w-full h-10 px-3.5 text-xs rounded-xl bg-slate-50 dark:bg-slate-900/80 text-slate-900 dark:text-slate-100 border border-slate-200 dark:border-slate-700 focus:border-indigo-500 focus:bg-white dark:focus:bg-slate-900 outline-none transition-all"
                  value={role}
              ...
              >
                {submitting ? "Creating Account..." : "Create Free Account"} <ArrowRight size={14} />
              </button>
            </form>
